<?php $this->load->view('backend/_layouts/header', ['title' => ucfirst(lang('edit')).' '.lang('purchase')]); ?>
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-header"><?= ucfirst(lang('edit')).' '.lang('purchase'); ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><?= ucfirst(lang('edit')).' '.lang('purchase'); ?></div>
                <div class="panel-body">
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('purchase_date')).' (*)'); ?>
                        <div class="input-group date">
                            <?= form_input('tanggal_pembelian', set_value('tanggal_pembelian', $pembelian->tanggal_pembelian), array('class' => 'form-control', 'id' => 'tanggal_pembelian')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            <?= form_input('tanggal_jatuh_tempo', set_value('tanggal_jatuh_tempo', $pembelian->tanggal_jatuh_tempo), array('class' => 'form-control', 'id' => 'tanggal_jatuh_tempo')); ?>
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <?= form_dropdown('id_pelanggan', $data, set_value('id_pelanggan', $pembelian->id_pelanggan), array('class' => 'form-control', 'id' => 'id_pelanggan')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?= form_dropdown('id_barang', $data, set_value('id_barang', $pembelian->id_barang), array('class' => 'form-control', 'id' => 'id_barang')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input([
                            ...
                            'readonly' => 'readonly',
                            'type' => 'number',
                            'value' => set_value('harga', $pembelian->harga)
                        ]); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input([
                            ...
                            'name' => 'kuantitas',
                            'type' => 'number',
                            'value' => set_value('kuantitas', $pembelian->kuantitas)
                        ]); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input([
                            ...
                            'name' => 'total',
                            'readonly' => 'readonly',
                            'value' => set_value('total', $pembelian->total)
                        ]); ?>
                        <?= form_error('total', '<p class="text-danger">', '</p>'); ?>
                    </div>
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('status')).' (*)'); ?>
                        <?= form_dropdown('status', $status, set_value('status', $pembelian->status), array('class' => 'form-control')); ?>
