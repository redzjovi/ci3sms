<?php $this->load->view('backend/_layouts/header', ['title' => ucfirst(lang('add')).' '.lang('goods')]); ?>
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-header"><?= ucfirst(lang('add')).' '.lang('goods'); ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><?= ucfirst(lang('add')).' '.lang('goods'); ?></div>
                <div class="panel-body">
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('product_name')).' (*)'); ?>
                        <?= form_input('nama_barang', set_value('nama_barang'), array('class' => 'form-control')); ?>
                        <?= form_error('nama_barang', '<p class="text-danger">', '</p>'); ?>
                    </div>
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('size')).' (*)'); ?>
                        <?= form_input('ukuran', set_value('ukuran'), array('class' => 'form-control')); ?>
                        <?= form_error('ukuran', '<p class="text-danger">', '</p>'); ?>
                    </div>
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('price')).' (*)'); ?>
                        <?= form_input('harga', set_value('harga'), array('class' => 'form-control')); ?>
                        <?= form_error('harga', '<p class="text-danger">', '</p>'); ?>
                    </div>
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('stock')).' (*)'); ?>
                        <?= form_input('stok', set_value('stok'), array('class' => 'form-control')); ?>
