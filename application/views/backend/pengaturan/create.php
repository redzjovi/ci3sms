<?php $this->load->view('backend/_layouts/header', ['title' => ucfirst(lang('add')).' '.lang('setting')]); ?>
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-header"><?= ucfirst(lang('add')).' '.lang('setting'); ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><?= ucfirst(lang('add')).' '.lang('setting'); ?></div>
                <div class="panel-body">
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('type')).' (*)'); ?>
                        <?= form_input('tipe', set_value('tipe'), array('class' => 'form-control')); ?>
                        <?= form_error('tipe', '<p class="text-danger">', '</p>'); ?>
                    </div>
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('message')).' (*)'); ?>
                        <?= form_textarea('pesan', set_value('pesan'), array('class' => 'form-control')); ?>
                        <?= form_error('pesan', '<p class="text-danger">', '</p>'); ?>
                    </div>
                    <div class="form-group">
                        <?= form_label(ucfirst(lang('due_date')).' (*)'); ?>
                        <?= form_input('jatuh_tempo', set_value('jatuh_tempo'), array('class' => 'form-control')); ?>
